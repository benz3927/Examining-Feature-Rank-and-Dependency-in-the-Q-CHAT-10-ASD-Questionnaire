...
questions. From our chi-square tests and random forest model, we observe
a high level of dependency among the similarly ranked most important
variables, a moderate level of dependency among similarly low ranked
variables, and no statistically significant relationship between top and
bottom groups of variables. To improve the Q-CHAT-10 survey methodology,
we suggest selecting the most representative questions out of groupings
of similarly-ranked high and low-importance questions while developing
research on new survey questions, which may be able to help with early
ASD identification.
...
Feature importance provides us with some insights on which
...
variables. There are 1054 total individuals and 18 total variables.
...
|------------------|---------------|----------------|
| Prediction (no)  | 240           | 20             |
| Prediction (yes) | 14            | 568            |
